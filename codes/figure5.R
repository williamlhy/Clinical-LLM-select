...
#11:
#pl <- list(p11,p12,p13,p14,p17,p16,p15,p18)
...
myh <- mycolumn+4
myw <- mycolumn*5
# Save the plot grid with labels
#output_file <- paste0("plots/fig1_",plotcombj$model,"_",plotcombj$neighb,"_",plotcombj$algo,"_",mainspec)
#output_file <- ifelse(testoption==FALSE,output_file,paste0(output_file,"_test"))
# save as pdf
#ggsave(plot=plots, file=paste0(output_file,".pdf"), width = myw, height = myh)
ggsave(plot=plots2, file="plots3/fig2_leg2.pdf", width = myw, height = myh)
ggsave(plot=plots2, file="plots3/fig2_leg2.png", width = myw, height = myh, bg = "white")
